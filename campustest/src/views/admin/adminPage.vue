<template>
  <div class="min-h-screen overflow-x-hidden" style="background: #f0f8ff; color: #2c3e50">
    <!-- ===== 顶部导航栏 ===== -->
    <header
      class="fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-between px-6"
      style="
        background: #ffffff;
    ...
    >
      ...
      <!-- Tab 导航 -->
      <nav
        class="hidden md:flex items-center gap-1 p-1 rounded-xl"
      ...
      >
        <button
          ...
          "
          @mouseleave="
            activeTab !== tab.value ? ($event.currentTarget.style.background = 'transparent') : ''
          "
        >
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          @click="refresh"
          class="w-9 h-9 rounded-xl flex items-center justify-center transition-all hover:scale-105 active:scale-95"
    ...
    <!-- ===== 移动端底部 Tab ===== -->
    <nav
      class="md:hidden fixed bottom-0 left-0 right-0 z-50 h-16 flex items-center justify-around safe-area-pb"
      style="
        background: #ffffff;
        box-shadow: 0 -2px 12px rgba(139, 92, 246, 0.08);
    ...
    <main class="pt-16 pb-20 md:pb-8 min-h-screen">
      ...
      <div
        ...
        class="page-transition max-w-7xl mx-auto px-4 md:px-6 py-6 space-y-5"
      >
        <!-- 欢迎横幅 -->
        <div
        ...
        >
          ...
          ></div>
          <div
            class="absolute -top-8 -right-8 w-64 h-64 rounded-full opacity-15 blur-3xl"
            style="background: rgba(255, 255, 255, 0.3)"
          ></div>
          <div
            class="absolute bottom-0 left-0 w-40 h-40 rounded-full opacity-10 blur-2xl"
          ...
          >
            <div>
              <h2
                class="text-xl md:text-2xl font-bold mb-1 flex items-center gap-2"
                style="color: white; text-shadow: 0 2px 8px rgba(0, 0, 0, 0.15)"
              >
              ...
              <p style="color: rgba(255, 255, 255, 0.75); font-size: 13px">
                这里是您今天的运营数据中心，随时掌握业务动态
              </p>
            </div>
            <div class="flex items-center gap-3 flex-wrap">
              <div
                class="backdrop-blur-sm rounded-xl px-4 py-3 text-center transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
                style="
              ...
              >
                <p
                  ...
                  style="color: white; text-shadow: 0 1px 4px rgba(0, 0, 0, 0.15)"
                >
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div
            ...
            @mouseenter="
              $event.currentTarget.style.boxShadow = '0 8px 24px rgba(139, 92, 246, 0.15)'
              $event.currentTarget.style.borderColor = 'rgba(139, 92, 246, 0.2)'
            "
            @mouseleave="
              $event.currentTarget.style.boxShadow = '0 2px 8px rgba(139, 92, 246, 0.08)'
              $event.currentTarget.style.borderColor = 'rgba(139, 92, 246, 0.08)'
            "
          >
            <!-- 渐变标题栏 -->
            <div
              ...
              :style="{
                background:
                  'linear-gradient(90deg, ' + stat.accentColor + ', ' + stat.accentColor2 + ')',
              }"
            ></div>
            <!-- 光晕 -->
            <div
              class="absolute -top-4 -right-4 w-20 h-20 rounded-full opacity-10 blur-xl"
            ...
            <div class="flex items-start justify-between mb-3 relative z-10">
              <div
                ...
                :style="{ background: stat.accentColor + '15', color: stat.accentColor }"
              >
                <span class="text-xl" v-html="stat.icon"></span>
              </div>
            </div>

            <p class="text-3xl font-bold mb-0.5 relative z-10" style="color: #2c3e50">
              {{ stat.value }}
            </p>
            <p class="text-sm relative z-10" style="color: #546e7a">{{ stat.label }}</p>
            <p v-if="stat.sub" class="text-xs mt-1 relative z-10" style="color: #90a4ae">
              {{ stat.sub }}
            </p>
          </div>
        </div>
        ...
        <div class="grid md:grid-cols-5 gap-4">
          <!-- 订单状态分布 -->
          <div
            class="md:col-span-3 rounded-xl p-5 transition-all duration-300"
            style="
              background: #ffffff;
              border: 1px solid rgba(139, 92, 246, 0.08);
          ...
          >
            <h3 class="text-sm font-bold mb-5 flex items-center gap-2" style="color: #2c3e50">
              <span
                ...
                style="background: #a855f7; box-shadow: 0 0 8px rgba(168, 85, 247, 0.4)"
              ></span>
              订单状态分布
            </h3>
            ...
            <div class="relative flex justify-between">
              <!-- 连接线 -->
              <div
                class="absolute top-5 left-[calc(10%/2)] right-[calc(10%/2)] h-0.5"
                style="background: rgba(139, 92, 246, 0.12); top: 20px; height: 2px"
              ></div>
              <div
                class="absolute top-5 left-[calc(10%/2)] h-0.5 transition-all duration-500"
                :style="{
              ...
              >
                ...
                <div class="text-center">
                  <p
                    ...
                    :style="
                      getStepClass(step.status, i).includes('active') ||
                      getStepClass(step.status, i).includes('completed')
                        ? 'color: #8B5CF6;'
                        : 'color: #90A4AE;'
                    "
                  >
          ...
          <!-- 库存预警 -->
          <div
            class="md:col-span-2 rounded-xl p-5 transition-all duration-300"
            style="
              background: #ffffff;
              border: 1px solid rgba(139, 92, 246, 0.08);
              box-shadow: 0 2px 8px rgba(139, 92, 246, 0.05);
          ...
          >
            ...
            <div v-else class="space-y-2.5 max-h-52 overflow-y-auto custom-scrollbar">
              <div
                v-for="item in lowStockGoods"
                :key="item.id"
                class="flex items-center gap-3 p-2.5 rounded-xl transition-all duration-200 cursor-pointer group"
                style="background: rgba(139, 92, 246, 0.03)"
                @mouseenter="
                  $event.currentTarget.style.background =
                    item.stock <= 5 ? 'rgba(239, 83, 80, 0.06)' : 'rgba(255, 183, 77, 0.06)'
                  $event.currentTarget.style.borderColor =
                    item.stock <= 5 ? 'rgba(239, 83, 80, 0.15)' : 'rgba(255, 183, 77, 0.15)'
                "
                @mouseleave="
                  $event.currentTarget.style.background = 'rgba(139, 92, 246, 0.03)'
              ...
              >
                <div
                  ...
                  :style="{
                    background:
                      item.stock <= 5 ? 'rgba(239, 83, 80, 0.1)' : 'rgba(255, 183, 77, 0.1)',
                    color: item.stock <= 5 ? '#EF5350' : '#FFB74D',
                  }"
                >
                    ...
                    >
                      <div
                        ...
                        :style="{
                          ...
                          background: item.stock <= 5 ? '#EF5350' : '#FFB74D',
                        }"
                      ></div>
                    </div>
                    <span
                      class="text-[10px] font-bold"
                      :style="{ color: item.stock <= 5 ? '#EF5350' : '#FFB74D' }"
                      >{{ item.stock }}件</span
                    >
                  </div>
                </div>
                <span
                  class="opacity-0 group-hover:opacity-100 transition-opacity text-xs font-medium"
                  style="color: #8b5cf6"
                  >编辑</span
                >
              </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
          <button
            ...
            "
            @mouseenter="
              $event.currentTarget.style.borderColor = shortcut.hoverColor + '40'
              $event.currentTarget.style.boxShadow = '0 6px 20px ' + shortcut.hoverColor + '15'
            "
            @mouseleave="
              $event.currentTarget.style.borderColor = 'rgba(139, 92, 246, 0.1)'
              $event.currentTarget.style.boxShadow = '0 2px 8px rgba(139, 92, 246, 0.05)'
            "
          >
            <div
              class="w-9 h-9 rounded-xl flex items-center justify-center mb-3 transition-transform duration-300 group-hover:scale-110"
              :style="{ background: shortcut.hoverColor + '15', color: shortcut.hoverColor }"
            >
      ...
      <div
        ...
        class="page-transition max-w-7xl mx-auto px-4 md:px-6 py-6 space-y-4"
      >
        <!-- 返回 + 标题 -->
        <div class="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 class="text-lg font-bold flex items-center gap-2" style="color: #2c3e50">
              <svg class="w-5 h-5" fill="none" style="color: #8b5cf6" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  stroke-width="2"
          ...
          <div class="flex flex-wrap gap-2">
            <div class="flex-1 min-w-[200px] relative">
              ...
              <input
                ...
                "
                @focus="
                  $event.target.style.borderColor = 'rgba(139, 92, 246, 0.4)'
                  $event.target.style.background = '#FFFFFF'
                  $event.target.style.boxShadow = '0 0 0 3px rgba(139, 92, 246, 0.1)'
                "
                @blur="
                  $event.target.style.borderColor = 'rgba(139, 92, 246, 0.1)'
        ...
        <div v-else-if="orders.length > 0" class="space-y-3">
          <div
            ...
            "
            @mouseenter="
              $event.currentTarget.style.boxShadow = '0 8px 24px rgba(139, 92, 246, 0.1)'
              $event.currentTarget.style.borderColor = 'rgba(139, 92, 246, 0.15)'
            "
            @mouseleave="
              $event.currentTarget.style.boxShadow = '0 2px 8px rgba(139, 92, 246, 0.04)'
              $event.currentTarget.style.borderColor = 'rgba(139, 92, 246, 0.08)'
            "
          >
            <!-- 头部 -->
            <div class="flex items-start justify-between mb-4">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-xs" style="color: #90a4ae">
            ...
            <p
              ...
              style="color: #546e7a; background: rgba(139, 92, 246, 0.03)"
            >
              备注：{{ o.remark }}
            </p>
            ...
            <div v-if="o.designFile" class="mb-4">
              <a
                :href="o.designFile"
                target="_blank"
                class="inline-flex items-center gap-1.5 text-xs rounded-lg px-3 py-1.5 transition-all"
                style="
                  color: #a855f7;
            ...
            <div
              ...
              style="border-top: 1px solid rgba(139, 92, 246, 0.06)"
            >
              <div v-if="o.custom === '需要定制' && o.status === 1" class="w-full">
                <div
                  ...
                  "
                >
                  <p class="text-xs font-medium mb-2" style="color: #a855f7">
                    为该订单上传定制设计稿
                  </p>
                  <div class="flex flex-wrap gap-2 items-center">
                    <input
                      type="file"
                      :ref="(el) => (fileInputs[o.id] = el)"
                      accept=".jpg,.jpeg,.png,.gif,.webp,.pdf"
                      class="text-xs flex-1 min-w-[150px]"
                      style="color: #546e7a"
                    />
                    <button
                      @click="submitDesign(o)"
                      :disabled="!fileInputs[o.id]?.files[0] || uploadingOrderId === o.id"
              ...
              <template v-if="o.status === 2">
                <button
                  ...
                  style="
                    background: linear-gradient(135deg, #a855f7, #388e3c);
                ...
                <div class="flex items-center gap-1.5 ml-1">
                  <input
                    ...
                    :placeholder="'原:' + o.num"
                    class="w-20 px-2 py-1.5 rounded-lg text-xs transition-all"
                    style="
        ...
        <div
          v-else
          class="rounded-xl p-16 text-center transition-all duration-300"
          style="
            background: #ffffff;
            border: 1px solid rgba(139, 92, 246, 0.08);
            box-shadow: 0 2px 8px rgba(139, 92, 246, 0.05);
        ...
        >
          <div class="mb-6 flex justify-center">
            ...
            >
              ...
              <!-- 铅笔 -->
              <path
                d="M88 88L96 96L92 100L84 92L88 88Z"
          ...
          <p style="font-size: 14px; color: #546e7a; margin-bottom: 8px; font-weight: 500">
            当前还没有订单哦～
          </p>
          <p style="font-size: 12px; color: #90a4ae; margin-bottom: 16px">
            等待用户下单后，这里会展示订单信息
          </p>
          <button
            @click="
        ...
        <div v-if="orderTotal > orderPageSize" class="flex justify-center gap-2 flex-wrap">
          <button
            ...
            style="background: #ffffff; color: #546e7a; border: 1px solid rgba(139, 92, 246, 0.1)"
          >
            上一页
          </button>
          <div
      ...
      >
        ...
        <!-- 商品网格 -->
        <div
          v-else-if="goods.length > 0"
          class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3"
        >
          <div
            v-for="g in productsPage"
            :key="g.id"
            ...
            "
            :style="
              '--stock-color: ' + (g.stock <= 5 ? '#EF5350' : g.stock <= 10 ? '#FFB74D' : '#A855F7')
            "
            @mouseenter="
              $event.currentTarget.style.boxShadow = '0 8px 24px rgba(139, 92, 246, 0.12)'
              $event.currentTarget.style.borderColor = 'rgba(139, 92, 246, 0.15)'
          ...
          >
            ...
            <div class="relative h-36 overflow-hidden" style="background: rgba(139, 92, 246, 0.02)">
              ...
              <div class="absolute top-2 left-2">
                <span
                  class="px-2 py-0.5 rounded-full text-[10px] font-medium backdrop-blur-sm border"
                  :style="
                    g.category === 'wenchuang'
                      ? 'background: rgba(139, 92, 246, 0.1); color: #8B5CF6; border-color: rgba(139, 92, 246, 0.15);'
                      : 'background: rgba(168, 85, 247, 0.1); color: #A855F7; border-color: rgba(168, 85, 247, 0.15);'
                  "
                >
                  {{ g.categoryText }}
                </span>
              ...
              >
                <div
                  ...
                  :style="{
                    width: Math.min((g.stock / 100) * 100, 100) + '%',
                    background: 'linear-gradient(90deg, var(--stock-color), var(--stock-color)aa)',
                  }"
                ></div>
              </div>
            </div>
            ...
            <div class="p-4">
              <div class="flex items-start justify-between gap-2 mb-2">
                <h3 class="text-sm font-bold truncate flex-1" style="color: #2c3e50">
                  {{ g.name }}
                </h3>
                <span class="text-sm font-bold flex-shrink-0" style="color: #8b5cf6"
                  >¥{{ g.price }}</span
                >
              </div>
              <p class="text-xs truncate mb-3" style="color: #90a4ae">
                {{ g.spec || g.desc || '暂无规格描述' }}
              </p>
                ...
                <div class="flex-1">
                  <div class="flex justify-between mb-1" style="color: #90a4ae">
                    ...
                    <span
                      class="font-bold"
                      :style="{
                        color: g.stock <= 5 ? '#EF5350' : g.stock <= 10 ? '#FFB74D' : '#546E7A',
                      }"
                      >{{ g.stock }}</span
                    >
                  </div>
                  ...
                  >
                    <div
                      ...
                      :style="{
                        width: Math.min((g.stock / 100) * 100, 100) + '%',
                        background:
                          'linear-gradient(90deg, var(--stock-color), var(--stock-color)aa)',
                      }"
                    ></div>
                  </div>
                </div>
        ...
        >
          ...
          <p style="font-size: 14px; color: #546e7a; margin-bottom: 6px; font-weight: 500">
            还没有上架商品哦～
          </p>
        ...
        <Transition name="dialog">
          ...
          >
            ...
            ></div>
            <div
              class="relative rounded-xl max-w-lg w-full overflow-hidden max-h-[90vh] overflow-y-auto custom-scrollbar"
              style="
                background: #ffffff;
                border: 1px solid rgba(139, 92, 246, 0.1);
            ...
            >
              <div class="p-6">
                <div class="flex items-center justify-between mb-5">
                  <h3 class="text-base font-bold" style="color: #2c3e50">
                ...
                <div class="space-y-4">
                  <div>
                    <label class="block text-xs font-medium mb-1.5" style="color: #546e7a"
                      >商品名称 <span style="color: #ef5350">*</span></label
                    >
                    <input
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    <div>
                      <label class="block text-xs font-medium mb-1.5" style="color: #546e7a"
                        >价格 (元) <span style="color: #ef5350">*</span></label
                      >
                      <input
                        type="number"
                    ...
                    <div>
                      <label class="block text-xs font-medium mb-1.5" style="color: #546e7a"
                        >库存 <span style="color: #ef5350">*</span></label
                      >
                      <input
                        type="number"
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        v-model.number="productForm.minOrder"
                        class="w-full px-4 py-2.5 rounded-xl text-sm transition-all"
                        style="
                          background: #f0f8ff;
                          border: 1px solid rgba(139, 92, 246, 0.1);
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="2"
                      class="w-full px-4 py-3 rounded-xl text-sm resize-none transition-all"
                      style="
                        background: #f0f8ff;
                        border: 1px solid rgba(139, 92, 246, 0.1);
                        color: #2c3e50;
                  ...
                  <div>
                    ...
                    >
                    <textarea
                      v-model="productForm.customRequirement"
                      rows="2"
                      class="w-full px-4 py-3 rounded-xl text-sm resize-none transition-all"
                      style="
                        background: #f0f8ff;
    ...
    <Transition name="dialog">
      ...
      >
        ...
        ></div>
        <div
          class="relative rounded-xl max-w-md w-full overflow-hidden"
          style="
            background: #ffffff;
            border: 1px solid rgba(139, 92, 246, 0.1);
            box-shadow: 0 24px 80px rgba(0, 0, 0, 0.15);
        ...
        >
          <div class="p-6">
            <h3 class="text-base font-bold mb-4 flex items-center gap-2" style="color: #2c3e50">
              批量导入结果
            </h3>
            <div
              v-if="importData.successCount > 0"
              ...
              "
            >
              <p class="text-sm font-medium" style="color: #a855f7">
                成功导入 {{ importData.successCount }} 件商品
              </p>
            </div>
            <div v-if="importData.errors && importData.errors.length > 0">
              <p class="text-sm font-medium mb-2" style="color: #ef5350">
                导入失败 {{ importData.errors.length }} 条
              </p>
              <div class="space-y-2 max-h-48 overflow-y-auto custom-scrollbar">
                <div
                  v-for="(err, idx) in importData.errors"
                  :key="idx"
...
const adminOrderFilters = [
  {
    value: 'all',
    label: '全部',
    icon: '<svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>',
  },
  {
    value: 1,
    label: '待上传',
    icon: '<svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3-3m0 0l3 3m-3-3v12"/></svg>',
  },
  {
    value: 2,
    label: '待审核',
  ...
  },
  {
    value: 4,
    label: '已完成',
    icon: '<svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
  },
  {
    value: 5,
    label: '已驳回',
    icon: '<svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
  },
]
...
const statCards = computed(() => [
  {
    label: '今日新增订单',
    value: adminStats.value.todayOrders,
  ...
  {
    label: '待审核订单',
    value: adminStats.value.pendingReview,
  ...
  {
    label: '待审核定制图',
    value: adminStats.value.pendingDesign,
...
const shortcuts = computed(() => [
  {
    label: '订单管理',
    sub: `${adminStats.value.totalOrders} 条订单待处理`,
  ...
  {
    label: '商品管理',
    sub: `${adminStats.value.totalProducts} 件商品在架`,
    icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>',
...
async function refresh() {
  ...
  await Promise.all([
    loadStats(),
    activeTab.value === 'orders' ? loadOrders() : null,
    activeTab.value === 'products' ? loadProducts() : null,
  ])
...
const saveProduct = async () => {
  ...
  try {
    ...
    if (e.errors?.length) {
      e.errors.forEach((err) => ElMessage.error(`「${err.field}」：${err.reason}`))
    } else {
...
const deleteProduct = (g) => {
  ElMessage.confirm(`确定删除「${g.name}」？`, '删除商品', {
...
const handleImport = async (e) => {
  ...
  try {
    ...
    if (result.successCount > 0)
      ElMessage.success(
        `导入完成：成功 ${result.successCount} 条，失败 ${result.errors?.length || 0} 条`,
      )
...
const statusStyle = (s) => {
  const styles = {
    1: {
      container:
        'padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 500; background: rgba(255, 183, 77, 0.1); color: #FFB74D; border: 1px solid rgba(255, 183, 77, 0.15);',
    },
    2: {
      container:
        'padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 500; background: rgba(139, 92, 246, 0.1); color: #8B5CF6; border: 1px solid rgba(139, 92, 246, 0.15);',
    },
    3: {
      container:
        'padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 500; background: rgba(255, 183, 77, 0.12); color: #FFB74D; border: 1px solid rgba(255, 183, 77, 0.2);',
    },
    4: {
      container:
        'padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 500; background: rgba(168, 85, 247, 0.1); color: #A855F7; border: 1px solid rgba(168, 85, 247, 0.15);',
    },
    5: {
      container:
        'padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 500; background: rgba(239, 83, 80, 0.08); color: #EF5350; border: 1px solid rgba(239, 83, 80, 0.12);',
    },
  }
